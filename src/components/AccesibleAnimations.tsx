'use client'
import { AnimatePresence, Variants, useReducedMotion } from 'framer-motion'
...
const AccesibleAnimations = (props: Props) => {
  ...
  // TODO Este hijo tiene el hook useReducedMotion para que no se vea la animacion
  return (
    <>
      <VariantsCustomChild
        variants={variants}
...
export default AccesibleAnimations